...
class ValueConstant{
  ...
  static const List<String> COUNTRY =  ['Select Country','CHINA', 'MALAYSIA','PHILIPPINES', 'INDIA', 'INDONESIA', 'CAMBODIA', 'BANGLADESH', 'LAOS', 'TURKEY', 'MOROCCO', 'PAKISTAN','VIETNAM', 'THAILAND', 'HONGKONG', 'SRILANKA','TAIWAN'];
  ...
  static const List<String> MATERIAL_NAME = ['Select material', 'COTTON', 'OTHERS', 'NYLON', 'VISCOSE','WOOL','ELASTANE','CASHMERE', 'SPANDEX','RAYON','ACRYLIC','POLYESTER','POLYAMIDE','MOHAIR','SILK'];
} 