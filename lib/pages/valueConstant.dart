...
class ValueConstant{
  ...
  static const List<String> MATERIAL_NAME = ['Select material', 'COTTON', 'OTHERS', 'NYLON', 'VISCOSE','WOOL','ELASTANE','CASHMERE', 'SPANDEX','RAYON','ACRYLIC','ELASTANE','POLYESTER','POLYAMIDE','MOHAIR','SILK'];
} 